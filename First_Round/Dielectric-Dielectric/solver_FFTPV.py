def sel_em_TPV(t_d,t_m,t_ARC,wp_S,gam_S,epsinf_a,wLO_a,wTO_a,gam_a,epsinf_b,wLO_b,wTO_b,gam_b,epsinf_ARC,wLO_ARC,wTO_ARC,gam_ARC,EQE):
    ...
    for i in range(1999):
        ...
        eps_a[i,0] = w
        eps_a[i,1] = np.real(Lorentz(w,epsinf_a,wLO_a,wTO_a,gam_a))
        eps_a[i,2] = np.imag(Lorentz(w,epsinf_a,wLO_a,wTO_a,gam_a))

        eps_b[i,0] = w
        eps_b[i,1] = np.real(Lorentz(w,epsinf_b,wLO_b,wTO_b,gam_b))
        eps_b[i,2] = np.imag(Lorentz(w,epsinf_b,wLO_b,wTO_b,gam_b))
    ...
    sim.AddLayer(layer_name = 'Dielectric_a_6', thickness = t_d, material_name = 'Dielectric_a')
    sim.AddLayer(layer_name = 'Dielectric_b_6', thickness = t_m, material_name = 'Dielectric_b')
    ...
    sim.SetSourceLayer(layer_name = 'Dielectric_a_6')
    sim.SetSourceLayer(layer_name = 'Dielectric_b_6')
